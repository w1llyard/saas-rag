            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-lg md:text-xl text-muted-foreground mb-8">
                  Upload PDFs, TXTs, or Markdown, then ask questions and get
                  context-aware answers powered by Gemini AI.
                </p>
                  ...
                  <div className="p-4 flex flex-col gap-4">
                    <div className="flex flex-col gap-3 max-h-[300px] overflow-y-auto">
                      ...
                      <div className="flex gap-3 items-start">
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-3 text-sm max-w-[80%]">
                          <p>
                            Based on your documents, our main feature is the
                            ability to create AI chatbots trained on your
                            specific content. You can upload PDFs, TXTs, or
                            Markdown files, and our system will process them to
                            create a knowledge base for your chatbot.
                          </p>
                        </div>
                      </div>
                    </div>
        ...
        >
          ...
          <div className="container px-4 md:px-6 relative">
            ...
            >
              ...
              <p className="max-w-[800px] text-muted-foreground md:text-lg">
                Get started in minutes and transform your documents into
          ...
          <div className="container px-4 md:px-6">
            ...
            >
              ...
              <p className="max-w-[800px] text-muted-foreground md:text-lg">
                ...
                businesses improve their customer support and knowledge
                management.
              </p>
            </motion.div>
                  ...
                  {testimonials.map((testimonial, i) => (
                    <motion.div
                      ...
                      animate={{
                        ...
                        position:
                          activeTestimonial === i ? "relative" : "absolute",
        ...
        <section id="faq" className="w-full py-20 md:py-32 bg-muted/30">
          <div className="container px-4 md:px-6">
            ...
            >
              ...
              <p className="max-w-[800px] text-muted-foreground md:text-lg">
                Find answers to common questions about RAG SaaS and how it can
                help your business.
              </p>
            </motion.div>
          ...
          <div className="container px-4 md:px-6 relative">
            ...
            >
              ...
              <p className="mx-auto max-w-[700px] text-white/80 md:text-xl">
                Join hundreds of businesses already using RAG SaaS to create
                intelligent chatbots from their documents.
              </p>
        ...
        <div className="container flex flex-col gap-8 px-4 py-10 md:px-6 lg:py-16">
          <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                Turn your documents into intelligent AI chatbots powered by
                Google's Gemini AI.
              </p>
